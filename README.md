...
|----------|---------|---------|
| `/api/linhaprods` | GET / POST / PUT / DELETE | CRUD de LinhaProd |
| `/api/produtoindustrials` | GET / POST / PUT / DELETE | CRUD de ProdutoIndustrial |
| `/api/ordemproducaos` | GET / POST / PUT / DELETE | CRUD de OrdemProducao |
| `/api/registroproducaos` | GET / POST / PUT / DELETE | CRUD de RegistroProducao |
